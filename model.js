...
// Modelo de datos.
//
// En esta variable se mantienen todos lo quizzes existentes.
...
*
* Este método carga el contenido del fichero DB_FILENAME en la variable quizzes. El contenido de ese fichero está en formato JSON.
* La primera vez que se ejecute este método, el fichero DB_FILENAME no existe, y se producirá el error ENOENT. En este caso se salva el contenido inicial almacenado en quizzs.
...
* Si se produce algún tipo de arror, se anza una excepción que abortará
 la ejecución del programa.
*/
const save = () => {
...
*
* @returns {number} número total de preguntas eistentes.
*/
...
*
* @param id        Clave que identifica el quiz actualizar.
* @param question  String con la pregunta.
* @param answer    String con la respuesta.
*/
...
*
* Para clonal el quiz se sa stringify + parse.
*
* @param id Clave que identifica el quiz a devolver.
*
* @returns {question, answer} Devuelve el objeto de la posición dada
*/
